...
import {Heading, Link, VStack, useColorMode} from "@chakra-ui/react"
...
return (
<VStack><Heading sx={{"fontSize": "2em"}}>{`Tour builder page`}</Heading>
<NextLink href="http://localhost:3000/"
passHref={true}><Link sx={{"border": "0.1em solid", "padding": "0.5em", "borderRadius": "0.5em", "_hover": {"color": "rgb(107,99,246)"}}}>{`Home`}</Link></NextLink>
